...
export default function Profile() {
    ...
    useEffect(() => {
        const fetchUser = async () =>{
          const res = await axios.get(`http://localhost:5000/server/users?username=${username}`);
          setUser(res.data);
        };
        fetchUser();   
      },[username])
        ...
        <>
            ...
            <div className="profile">
                ...
                <div className="profileRight">
                    ...
                    <div className="profileRightBottom"><Feed username={username}/><Rightbar user={user}/></div>
                </div>
            </div>
        </>
    )
