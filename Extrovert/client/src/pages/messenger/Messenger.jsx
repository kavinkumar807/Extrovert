...
export default function Messenger() {
   ...
   useEffect(()=>{
    ...
    useEffect(()=>{
        const getConversations = async ()=>{
            try{
                const res = await axios.get("http://localhost:5000/server/conversation/"+user._id);
   ...
   useEffect(() => {
       const getMessages = async () =>{
           try{
                const res = await axios.get("http://localhost:5000/server/message/"+currentChat?._id);
   ...
   const handleSubmit = async (e) => {
        ...
        try{
            const res = await axios.post("http://localhost:5000/server/message",message);
